...
Description: common-dashboard_widgets.php loads commonly access Dashboard widgets across the GaJeLabs suite.
Version: 2.0

*/

/* Start of: WooCommerce News - by GaJeLabs */

if( !function_exists( 'woo_vl_dashboard_setup' ) ) {

	function woo_vl_dashboard_setup() {

		wp_add_dashboard_widget( 'woo_vl_news_widget', __( 'Plugin News - by GaJeLabs', 'woo_vl' ), 'woo_vl_news_widget' );
	...
	function woo_vl_news_widget() {
		...
		$rss = fetch_feed( 'http://gajelabs.com/blog/category/woocommerce/feed/' );
...
/* End of: WooCommerce News - by GaJeLabs */
?>